...
export const courses: Course[] = [
  {
    ...
    image: {
      ...
      alt: 'Học viên ngồi ghế lái xe tập lái số tự động, bên phải là cần số tự động',
      width: 947,
      height: 592,
    },
    featured: true,
  ...
  },
  {
    ...
    image: {
      src: '/images/courses/hang-b-so-san.webp',
      alt: 'Xe con tập lái số sàn gắn biển TẬP LÁI, đỗ tại sân của trung tâm',
      width: 947,
      height: 592,
    },
    featured: true,
  ...
  },
  {
    ...
    image: {
      src: '/images/courses/hang-c1.webp',
      alt: 'Xe tải tập lái hạng C1 gắn biển TẬP LÁI, đỗ tại sân tập của trung tâm',
      width: 947,
      height: 592,
    },
    featured: true,
  ...
  },
  {
    ...
    image: {
      src: '/images/courses/luyen-sa-hinh.webp',
      alt: 'Xe tập lái đỗ gọn trong ô kẻ vạch tại sân tập, dùng cho bài ghép xe',
      width: 960,
      height: 600,
    },
    featured: true,
